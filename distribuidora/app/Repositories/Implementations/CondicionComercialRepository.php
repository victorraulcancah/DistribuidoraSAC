...
class CondicionComercialRepository extends BaseRepository implements CondicionComercialRepositoryInterface
{
    public function __construct(CondicionComercial $model)
    {
